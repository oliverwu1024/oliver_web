...
export default function HamsterWheel() {
  ...
  return (
    <svg className="w-44 h-44 sm:w-56 sm:h-56 inline-block" viewBox="0 0 200 140" preserveAspectRatio="xMidYMid meet" fill="none">
      {/* ── Wheel ── */}
      <g style={{ transformOrigin: "70px 70px", animation: running ? "hamster-wheel-spin 2s linear infinite" : "none" }}>
        <circle cx="70" cy="70" r="42" fill="none" stroke={s(0.25)} strokeWidth="2" />
        <circle cx="70" cy="70" r="38" fill="none" stroke={s(0.1)} strokeWidth="1" />
        <line x1="70" y1="28" x2="70" y2="112" stroke={s(0.1)} strokeWidth="1" />
        <line x1="28" y1="70" x2="112" y2="70" stroke={s(0.1)} strokeWidth="1" />
        <line x1="40" y1="40" x2="100" y2="100" stroke={s(0.08)} strokeWidth="1" />
        <line x1="100" y1="40" x2="40" y2="100" stroke={s(0.08)} strokeWidth="1" />
        <line x1="108" y1="70" x2="112" y2="70" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="103" y1="89" x2="106" y2="91" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="89" y1="103" x2="91" y2="106" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="70" y1="108" x2="70" y2="112" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="51" y1="103" x2="49" y2="106" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="37" y1="89" x2="34" y2="91" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="32" y1="70" x2="28" y2="70" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="37" y1="51" x2="34" y2="49" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="51" y1="37" x2="49" y2="34" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="70" y1="32" x2="70" y2="28" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="89" y1="37" x2="91" y2="34" stroke={s(0.2)} strokeWidth="1.5" />
        <line x1="103" y1="51" x2="106" y2="49" stroke={s(0.2)} strokeWidth="1.5" />
      </g>
      <circle cx="70" cy="70" r="4" fill="rgba(167,139,250,0.6)" stroke="rgba(167,139,250,0.4)" strokeWidth="1" />

      {/* ── Stand ── */}
      <line x1="45" y1="112" x2="70" y2="112" stroke={s(0.3)} strokeWidth="2" strokeLinecap="round" />
      <line x1="70" y1="112" x2="95" y2="112" stroke={s(0.3)} strokeWidth="2" strokeLinecap="round" />
      <line x1="45" y1="112" x2="38" y2="128" stroke={s(0.25)} strokeWidth="2" strokeLinecap="round" />
      <line x1="95" y1="112" x2="102" y2="128" stroke={s(0.25)} strokeWidth="2" strokeLinecap="round" />
      <line x1="30" y1="128" x2="48" y2="128" stroke={s(0.2)} strokeWidth="2" strokeLinecap="round" />
      <line x1="94" y1="128" x2="112" y2="128" stroke={s(0.2)} strokeWidth="2" strokeLinecap="round" />
      ...
      <g style={{ transform: running ? "translateY(-2px)" : "translateY(0px)", transition: "transform 0.3s ease" }}>
        ...
        {running ? (
          <>
            <line x1="80" y1="101" x2={legPhase % 2 === 0 ? "84" : "78"} y2={legPhase % 2 === 0 ? "108" : "109"} stroke="rgba(251,191,36,0.6)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="76" y1="102" x2={legPhase % 2 === 0 ? "73" : "79"} y2={legPhase % 2 === 0 ? "109" : "108"} stroke="rgba(251,191,36,0.6)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="66" y1="102" x2={legPhase < 2 ? "70" : "63"} y2={legPhase < 2 ? "109" : "108"} stroke="rgba(251,191,36,0.6)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="62" y1="101" x2={legPhase < 2 ? "58" : "65"} y2={legPhase < 2 ? "108" : "109"} stroke="rgba(251,191,36,0.6)" strokeWidth="2.5" strokeLinecap="round" />
          </>
        ) : (
          <>
      ...
      {/* ── Light bulb ── */}
      <g>
        <circle cx="122" cy="102" r="10" fill={running ? "rgba(251,191,36,0.15)" : s(0.03)} stroke={running ? "rgba(251,191,36,0.6)" : s(0.2)} strokeWidth="1.5" style={{ transition: "all 0.5s ease" }} />
        <rect x="118" y="111" width="8" height="5" rx="1" fill={s(0.15)} stroke={running ? "rgba(251,191,36,0.4)" : s(0.2)} strokeWidth="1" />
        <line x1="118" y1="113" x2="126" y2="113" stroke={running ? "rgba(251,191,36,0.3)" : s(0.1)} strokeWidth="0.8" />
        <path d="M119 102 C120 98 121 104 122 100 C123 104 124 98 125 102" stroke={running ? "rgba(251,191,36,0.9)" : s(0.15)} strokeWidth="1.2" fill="none" strokeLinecap="round" style={{ transition: "stroke 0.5s ease" }} />
        {running && (
          <>
      ...
      {/* ── Laptop ── */}
      <g>
        <rect x="138" y="126" width="48" height="5" rx="2" fill={s(0.15)} stroke={s(0.25)} strokeWidth="1" />
        <rect x="141" y="96" width="42" height="30" rx="3" fill="rgba(99,102,241,0.1)" stroke={s(0.3)} strokeWidth="1.5" />
        <circle cx="162" cy="99" r="1" fill={s(0.2)} />
        {running ? (
          <>
