...
export default function TuxPenguin() {
  ...
  return (
    <svg className="w-28 h-28 sm:w-36 sm:h-36 inline-block" viewBox="0 0 180 160" fill="none">
      {/* ── Desk ── */}
      <rect x="8" y="118" width="164" height="6" rx="3" fill={s(0.1)} stroke={s(0.25)} strokeWidth="1" />

      {/* ── Monitor ── */}
      <rect x="28" y="112" width="4" height="8" fill={s(0.2)} />
      ...
      {/* ── Keyboard ── */}
      <rect x="14" y="114" width="36" height="4" rx="1.5" fill={s(0.15)} stroke={s(0.3)} strokeWidth="0.8" />
      <rect x="17" y="114.5" width="4" height="2.5" rx="0.5" fill={keyPress && isTyping ? "rgba(167,139,250,0.5)" : s(0.1)} style={{ transition: "fill 0.15s" }} />
      <rect x="23" y="114.5" width="4" height="2.5" rx="0.5" fill={!keyPress && isTyping ? "rgba(167,139,250,0.5)" : s(0.1)} style={{ transition: "fill 0.15s" }} />
      <rect x="29" y="114.5" width="4" height="2.5" rx="0.5" fill={keyPress && isTyping ? "rgba(167,139,250,0.5)" : s(0.1)} style={{ transition: "fill 0.15s" }} />
      <rect x="35" y="114.5" width="4" height="2.5" rx="0.5" fill={!keyPress && isTyping ? "rgba(167,139,250,0.5)" : s(0.1)} style={{ transition: "fill 0.15s" }} />

      {/* ── Penguin body ── */}
      <ellipse cx="110" cy="95" rx="30" ry="32" fill="#1a1a2e" stroke={s(0.5)} strokeWidth="1.5" />
      <ellipse cx="110" cy="98" rx="18" ry="22" fill={s(0.12)} stroke={s(0.3)} strokeWidth="1" />

      {/* ── Head ── */}
      <circle cx="110" cy="52" r="24" fill="#1a1a2e" stroke={s(0.5)} strokeWidth="1.5" />
      <ellipse cx="110" cy="55" rx="15" ry="14" fill={s(0.1)} stroke={s(0.2)} strokeWidth="0.8" />
      ...
      {/* ── Left wing ── */}
      <path
        d={isTyping ? "M80 80 C72 90 60 105 52 114" : "M80 80 C74 92 72 104 78 116"}
        stroke={s(0.5)} strokeWidth="5" strokeLinecap="round" fill="none"
        style={{ transition: "d 0.5s ease" }}
      />
      {isTyping ? (
        <circle cx="52" cy="114" r="4" fill="#1a1a2e" stroke={s(0.5)} strokeWidth="1.5" />
      ) : (
        <circle cx="78" cy="116" r="4" fill="#1a1a2e" stroke={s(0.5)} strokeWidth="1.5" />
      )}

      {/* ── Right arm ── */}
      <path
        d={isTyping ? "M140 80 C146 90 148 105 142 114" : "M140 76 C150 68 154 56 152 46"}
        stroke={s(0.5)} strokeWidth="5" strokeLinecap="round" fill="none"
        style={{ transition: "d 0.5s ease" }}
      />
      {isTyping ? (
        <circle cx="142" cy="114" r="4" fill="#1a1a2e" stroke={s(0.5)} strokeWidth="1.5" />
      ) : (
