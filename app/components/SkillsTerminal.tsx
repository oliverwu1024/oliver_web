...
export default function SkillsTerminal() {
  ...
  return (
    <div ref={termRef} className="w-full mx-auto">
      <div className="rounded-xl border border-foreground/10 overflow-hidden shadow-2xl shadow-accent/5">
        {/* Title bar */}
        <div className="flex items-center gap-2 px-4 py-3 bg-surface-2 border-b border-foreground/5">
